...
object HabitatsRimward {
  ...
  // Main Belt
  object Aspis
      extends Habitat("Aspis",
                      UUID.randomUUID(),
                      Kilograms(3.6e11),
                      ONeillCylinder(Kilometers(192), Kilometers(8)),
                      Stars.Sol,
                      Ultimates,
                      Seq(Burmese, English, Russian),
                      Seq())
      with Orbiting {
  ...
  object Extropia
      extends Habitat("Extropia (44 Nysa)",
                      UUID.randomUUID(),
                      Kilograms(3.6e11),
                      Asteroid("Beehive", 113.0.km, 67.0.km, 65.0.km),
                      Stars.Sol,
                      Extropian,
                      Seq(Cantonese, English, Russian, Spanish),
                      Seq(Trade, Shipping, Politics))
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.148158617,
                                        2.42380478.AU,
                                        3.7028885.º,
                                        131.59519.º,
                                        342.52066.º,
  ...
  object NovaYork
      extends Habitat("Nova York (9 Metis)",
                      UUID.randomUUID(),
                      Kilograms(1.47e19),
                      Asteroid("Beehive", 222.0.km, 182.0.km, 130.0.km),
                      Stars.Sol,
                      Independent(Autonomist),
                      Seq(English, French, Wu),
                      Seq(Finance, Art, Tourism))
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.122,
                                        2.387.AU,
                                        5.576.º,
                                        68.982.º,
                                        5.489.º,
  ...
  object Pallas
      extends Habitat("Pallas (2 Pallas)",
                      UUID.randomUUID(),
                      Kilograms(2.11e20),
                      Asteroid("Beehives/TinCan/Domes", 550.0.km, 516.0.km, 476.0.km),
                      Stars.Sol,
                      Independent(NightCartel),
                      Seq(English, Russian, Spanish),
                      Seq(Crime, Mining, Research, SoftwareDesign))
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.23127363,
                                        2.77160611.AU,
                                        34.840998.º,
                                        173.096248.º,
                                        309.930328.º,
  ...
  object Starwell
      extends Habitat("Starwell",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Torus(Kilometers(0.845), Kilometers(0.065)),
                      Stars.Sol,
                      ExoTech,
                      Seq(English, Mandarin, Serbian),
                      Seq(AI, ComSystems, SoftwareDesign, ImplantDesign, Research))
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.06, 2.71.AU, 0.2.º, 12.0.º, 47.0.º, 0.0.º, this.mass, Stars.Sol.mass);
    override def extraInfo =
      Seq(("Population" -> "50 000"), ("Note" -> "There is also a secondary Cluster, that is isolated for research."));
  }

  object Vesta
      extends Habitat("Vesta (4 Vesta)",
                      UUID.randomUUID(),
                      Kilograms(2.59076e20),
                      Asteroid("Beehives/TinCan/Domes", 572.0.km, 557.0.km, 446.0.km),
                      Stars.Sol,
                      Independent(),
                      Seq(Arabic, Hindi, Russian),
                      Seq(ZeroGManufacturing, AerospaceEngineering, Mining, RocketDesign))
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.08874,
                                        2.36179.AU,
                                        7.14043.º,
                                        103.85136.º,
                                        151.19853.º,
                                        ...
                                        Stars.Sol.mass); // wrong epoch for mean anomaly
    override def extraInfo =
      Seq(("Population" -> "250 000"),
          ("Note" -> "Vesta is orbited by a Cole Bubble called Vesta Prime, and the Starware shipyards."));
  }

  object Zombieland
      extends Habitat("Zombieland (349 Dembrowska)",
                      UUID.randomUUID(),
                      Kilograms(3.58e18),
                      Asteroid("Beehive and Cluster", 145.0.km, 140.0.km, 69.0.km),
                      Stars.Sol,
                      Independent(CorpAsPolity(Zrbny)),
                      Seq(),
                      Seq())
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.091473,
                                        2.92379.AU,
                                        8.2461.º,
                                        32.351.º,
                                        346.225.º,
  ...
  // Jupiter
  object Amalthea
      extends Habitat("Amalthea (Solano)",
                      UUID.randomUUID(),
                      Kilograms(2.08e18),
                      Asteroid("Reagan Cylinder", 250.0.km, 146.0.km, 128.0.km),
                      Planets.Jupiter,
                      Jovian,
                      Seq(English, Spanish),
                      Seq(Security, Research))
      with Orbiting {
  ...
  object TheCastle
      extends Habitat("The Castle",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Asteroid("Cluster/Beehive", 5.0.km, 2.2.km, 2.8.km),
                      Moons.Ganymede,
                      Jovian,
                      Seq(English, Spanish),
                      Seq(Security, SignalAnalysis))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0, 64000.0.km, 312.57.º, 232.20.º, 0.0.º, 0.0.º, this.mass, this.centre);
  }
  object TheHolySee
      extends Habitat("The Holy See",
                      UUID.randomUUID(),
                      Kilograms(2.4e12),
                      Asteroid("Reagan Cylinder", 20.0.km, 12.0.km, 9.0.km),
                      Moons.Ganymede,
                      Protectorate(Jovian, CatholicChurch),
                      Seq(Latin, English, Spanish),
                      Seq(Religion))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0, 79000.0.km, 342.57.º, 32.20.º, 89.0.º, 0.0.º, this.mass, this.centre);
  }

  object JSFAntimatterFactory
      extends Habitat("JSF Antimatter Factory",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Asteroid("Cluster/Beehive", 5.0.km, 2.2.km, 2.8.km),
                      Moons.Io,
                      Jovian,
                      Seq(English, Spanish),
                      Seq(Antimatter, Military))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0, 47000.0.km, 322.0.º, 89.0.º, 55.0.º, 0.0.º, this.mass, this.centre);
  }

  object Aoede
      extends Habitat("Aoede",
                      UUID.randomUUID(),
                      Kilograms(1.4e10), // infos are shaky
                      Asteroid("Unknown", 4.0.km, 4.0.km, 4.0.km),
                      Planets.Jupiter,
                      Protectorate(Jovian, NoPolity),
                      Seq(),
                      Seq())
      with Orbiting {
  ...
  object Aitne
      extends Habitat("Aitne",
                      UUID.randomUUID(),
                      Kilograms(1.4e8), // infos are shaky
                      Asteroid("Beehive", 1.5.km, 1.5.km, 1.5.km),
                      Planets.Jupiter,
                      CarmeCompact,
                      Seq(),
                      Seq())
  ...
  object Kale
      extends Habitat("Kale",
                      UUID.randomUUID(),
                      Kilograms(0.4e8), // infos are shaky
                      Asteroid("Beehive", 1.0.km, 1.0.km, 1.0.km),
                      Planets.Jupiter,
                      CarmeCompact,
                      Seq(),
                      Seq())
  ...
  object Taygete
      extends Habitat("Taygete",
                      UUID.randomUUID(),
                      Kilograms(2.4e9), // infos are shaky
                      Asteroid("Beehive", 2.5.km, 2.5.km, 2.5.km),
                      Planets.Jupiter,
                      CarmeCompact,
                      Seq(),
                      Seq())
  ...
  object Callirrhoe
      extends Habitat("Callirrhoe",
                      UUID.randomUUID(),
                      Kilograms(2.4e10), // infos are shaky
                      Asteroid("Dome", 8.6.km, 8.6.km, 8.6.km),
                      Planets.Jupiter,
                      Protectorate(Jovian, IndependentPolity),
                      Seq(),
                      Seq())
      with Orbiting {
    val orbit = new ConstantOrbit(0.2796,
                                  24.099e6.km,
                                  147.080.º,
                                  283.104.º,
                                  23.909.º,
                                  ...
                                  this.mass,
                                  this.centre,
                                  true); // no idea which Epoch
  }

  object Carpo
      extends Habitat("Carpo",
                      UUID.randomUUID(),
                      Kilograms(2.4e9), // infos are shaky
                      Asteroid("Beehive/Simulspace", 3.0.km, 3.0.km, 3.0.km),
                      Planets.Jupiter,
                      IndependentPolity,
                      Seq(English),
                      Seq())
  ...
  object Euanthe
      extends Habitat("Euanthe",
                      UUID.randomUUID(),
                      Kilograms(2.4e10), // infos are shaky
                      Asteroid("Dome/Beehive", 3.0.km, 3.0.km, 3.0.km),
                      Planets.Jupiter,
                      Protectorate(Jovian, IndependentPolity),
                      Seq(),
                      Seq())
  ...
  object Helike
      extends Habitat("Helike",
                      UUID.randomUUID(),
                      Kilograms(2.4e10), // infos are shaky
                      Asteroid("Reagan Cylinder", 4.0.km, 4.0.km, 4.0.km),
                      Planets.Jupiter,
                      NoPolity,
                      Seq(),
                      Seq())
  ...
  object Locus
      extends Habitat("Locus",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      NuestroShell(11.0.km),
                      Stars.Sol,
                      Autonomist,
                      Seq(AnyLang),
                      Seq(Art, Research, Military))
      with Orbiting {
    val orbit = new LissajousOrbit(JovianTrojans,
                                   20000000.0.km,
                                   2500000.0.km,
                                   RotationPeriod(Days(50.0)),
                                   RotationPeriod(Days(10.0)),
                                   3.229,
                                   Degrees(35.0),
                                   Degrees(125.0));
  ...
  object CSquat
      extends Habitat("C Squat",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      Asteroid("Beehive", 3.0.km, 3.0.km, 3.0.km),
                      Stars.Sol,
                      Autonomist,
                      Seq(English, Hindi, Spanish),
                      Seq(Art))
      with Orbiting {
    val orbit = new LissajousOrbit(JovianGreeks,
                                   20000000.0.km,
                                   2500000.0.km,
                                   RotationPeriod(Days(50.0)),
                                   RotationPeriod(Days(10.0)),
  ...
  object CasaArturo
      extends Habitat("Casa Arturo",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      NuestroShell(1.0.km),
                      Stars.Sol,
                      Autonomist,
                      Seq(English, Mandarin, Spanish),
                      Seq(RocketDesign, Mining, ZeroGManufacturing))
      with Orbiting {
    val orbit = new LissajousOrbit(JovianGreeks,
                                   20000000.0.km,
                                   2500000.0.km,
  ...
  object CatalHayuk
      extends Habitat("Catal Hayuk",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      ONeillCylinder(Kilometers(8), Kilometers(4)),
                      Stars.Sol,
                      Independent(Brinker),
                      Seq(Kurdish, Turkish),
                      Seq(Research))
  ...
  object Exarchia
      extends Habitat("Exarchia",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      Cluster,
                      Stars.Sol,
                      Autonomist,
                      Seq(English, Greek, Mandarin),
                      Seq(Hacktivism))
      with Orbiting {
    val orbit = new LissajousOrbit(JovianGreeks,
                                   20000000.0.km,
  ...
  object Lot49
      extends Habitat("Lot49",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      NuestroShell(1.0.km),
                      Stars.Sol,
                      Autonomist,
                      Seq(English, Portuguese, Thai),
  ...
  object Respect
      extends Habitat("Respect",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      BernalSphere(8.0.km),
                      Stars.Sol,
                      IndependentNamed("Sapient Uplift"),
                      Seq(Javanese, Tamil, Spanish),
                      Seq())
      with Orbiting {
    val orbit = new LissajousOrbit(JovianTrojans,
                                   20000000.0.km,
  ...
  object Turing
      extends Habitat("Turing",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      Asteroid("Beehive", 1.0.km, 0.5.km, 0.8.km),
                      Stars.Sol,
                      NoPolity,
                      Seq(),
                      Seq())
  ...
  object Winter
      extends Habitat("Winter",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      Asteroid("Cole bubble", 8.0.km, 5.2.km, 4.0.km),
                      Stars.Sol,
                      Independent(Brinker),
                      Seq(Arabic, Italian),
                      Seq())
  ...
  // Saturn
  object Volkograd
      extends Habitat("Volkograd (Atlas)",
                      UUID.randomUUID(),
                      Kilograms(6.6e15),
                      Asteroid("Beehive", 40.8.km, 35.4.km, 18.8.km),
                      Planets.Saturn,
                      Hypercorp(Volkov),
                      Seq(Czech, Slovak),
                      Seq(Mining, Shipping))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0012,
                                  0.137670e6.km,
                                  29.523.º,
                                  0.500.º,
                                  331.521.º,
                                  129.760.º,
                                  this.mass,
                                  this.centre); // wrong Epoch (2453005.5 JED)
    override def extraInfo = Seq(("Population" -> "50 000"));
  }

  object Bright
      extends Habitat("Bright (Telesto)",
                      UUID.randomUUID(),
                      Kilograms(4.8e10),
                      HamiltonCylinder(8.0.km, 1.0.km),
                      Planets.Saturn,
                      Hypercorp(Acumenic),
                      Seq(English, German, Mandarin),
                      Seq(Research))
      with Orbiting {
    val orbit = new LissajousOrbit(new L4(Planets.Saturn, Moons.Tethys),
                                   1205.0.km,
                                   798.0.km,
                                   RotationPeriod(Days(0.3)),
                                   RotationPeriod(Days(0.14)),
                                   2.934,
                                   213.0.º,
                                   67.0.º);
  ...
  object Kiviuq
      extends Habitat("Kiviuq Monastery",
                      UUID.randomUUID(),
                      Kilograms(6.6e12),
                      Asteroid("Beehive", 16.0.km, 16.0.km, 16.0.km),
                      Planets.Saturn, // shaky data
                      IndependentPolity,
                      Seq(Greek, Russian),
                      Seq(Religion))
      with Orbiting {
  ...
  object MeatHab
      extends Habitat("MeatHab",
                      UUID.randomUUID(),
                      Kilograms(4.8e10),
                      UniqueStation("MeatHab"),
                      Planets.Saturn,
                      IndependentPolity,
                      Seq(Mandarin, Polish, Turkish),
                      Seq(Art))
      with Orbiting {
    val orbit = new ConstantOrbit(0.000144,
                                  335847.0.km,
                                  29.3.º,
                                  0.0.º,
                                  0.0.º,
                                  ...
                                  this.mass,
                                  this.centre,
                                  retrograde = true); // no idea
    override def extraInfo = Seq(("Population" -> "500"));
  }

  object IZulu
      extends Habitat("iZulu (Pan)",
                      UUID.randomUUID(),
                      Kilograms(4.95e15),
                      Asteroid("Beehive", 34.4.km, 31.4.km, 20.8.km),
                      Planets.Saturn,
                      Autonomist,
                      Seq(Afrikaans, English, Xhosa, Zulu),
                      Seq(SoftwareDesign))
      with Orbiting {
  ...
  object PhelansRecourse
      extends Habitat("Phelan's Recourse",
                      UUID.randomUUID(),
                      Kilograms(3.2e7),
                      Cluster,
                      Planets.Saturn,
                      AA(Scum),
                      Seq(English, Mandarin, Skandinaviska),
                      Seq(Entertainment))
      with Orbiting {
    val orbit = VariableOrbit(0.792137,
                              681795.km,
                              87.0.º,
                              ConstantAngle(0.0.º),
                              ConstantAngle(0.0.º),
  ...
  object MarseillesPrometheus
      extends Habitat("Marseilles (Prometheus)",
                      UUID.randomUUID(),
                      Kilograms(1.595e17),
                      Asteroid("Beehive", 135.6.km, 79.4.km, 59.4.km),
                      Planets.Saturn,
                      AA(Titanian),
                      Seq(French, Skandinaviska, Vietnamese),
                      Seq(Antimatter, Chemistry, Mining, Transport))
      with Orbiting {
  ...
  object KronosCluster {
    ...
    val industries: Seq[Industry] =
      Seq(Art, Counterfeiting, Crime, Entertainment, Smuggling, Tourism, Trade, WaterExtraction);
    val geoSync: Length = 8407.2522.km;
    val info = Seq(("Population" -> "950 000"));

    object Atmos
        extends SyncOrbitStation(name,
                                 UUID.randomUUID(),
                                 (North(0, 0, 0), West(0, 0, 0)),
                                 (geoSync - moon.radius),
                                 moon, // no idea where exactly it is
                                 allegiance,
                                 langs,
                                 industries) {
    ...
    object Hab
        extends Habitat(name,
                        UUID.randomUUID(),
                        squants.Kilograms(2.4e10),
                        Cluster,
                        moon,
                        allegiance,
                        langs,
  ...
  object Salah
      extends Habitat("Salah (Calypso)",
                      UUID.randomUUID(),
                      Kilograms(4.8e10),
                      HamiltonCylinder(8.0.km, 1.0.km),
                      Planets.Saturn,
                      Contested,
                      Seq(Arabic, Punjabi, Turkish),
                      Seq(Finance, Religion))
      with Orbiting {
    val orbit = new LissajousOrbit(new L5(Planets.Saturn, Moons.Tethys),
                                   1215.0.km,
                                   788.0.km,
                                   RotationPeriod(Days(0.365)),
                                   RotationPeriod(Days(0.12)),
                                   2.534,
                                   0.0.º,
                                   0.0.º);
  ...
  object Epimetheus
      extends Habitat("Twelve Commons (Epimetheus)",
                      UUID.randomUUID(),
                      Kilograms(5.266e17),
                      Asteroid("Beehive", 129.8.km, 114.km, 106.2.km),
                      Planets.Saturn,
                      AA(Anarchists),
                      Seq.empty,
                      Seq.empty)
  ...
  object Janus
      extends Habitat("Twelve Commons (Janus Commons)",
                      UUID.randomUUID(),
                      Kilograms(1.8975e18),
                      Asteroid("Beehive", 203.km, 185.km, 152.6.km),
                      Planets.Saturn,
                      AA(Anarchists),
                      Seq(English, French, Spanish),
                      Seq(Art, Chemistry))
      with Orbiting {
  ...
  object DIYShipyards
      extends Habitat("Twelve Commons (DIY Shipyards)",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Cluster,
                      Planets.Saturn,
                      AA(Anarchists),
                      Seq(Arabic, Malay),
                      Seq(AerospaceEngineering, ZeroGManufacturing))
      with Orbiting {
  ...
  object LongHaul
      extends Habitat("Twelve Commons (Long Haul)",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Torus(Kilometers(0.845), Kilometers(0.065)),
                      Planets.Saturn,
                      AA(Anarchists),
                      Seq(English, Hindi, Mandarin),
                      Seq.empty)
      with Orbiting {
  ...
  object NguyensCompact
      extends Habitat("Twelve Commons (Nguyen's Compact)",
                      UUID.randomUUID(),
                      Kilograms(2.4e8),
                      Asteroid("Cole bubble", 8.0.km, 5.2.km, 4.0.km),
                      Planets.Saturn,
                      AA(Anarchists),
                      Seq(French, Khmer, Vietnamese),
                      Seq.empty)
      with Orbiting {
  ...
  object RedEmmasDance
      extends Habitat("Twelve Commons (Red Emma's Dance)",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Asteroid("Track", 15.0.km, 12.2.km, 6.0.km),
                      Planets.Saturn,
                      AA(Anarchists),
                      Seq(Greek, Italian),
                      Seq(Art, MorphDesign))
  ...
  object SmallMajesties
      extends Habitat("Twelve Commons (Small Majesties)",
                      UUID.randomUUID(),
                      Kilograms(1.4e10),
                      Asteroid("Cluster", 13.0.km, 11.2.km, 4.0.km),
                      Planets.Saturn,
                      AA(Anarchists),
                      Seq(Spanish, Tagalog),
                      Seq(NanoTechnology))
  ...
  object Phoebe
      extends Habitat("Phoebe",
                      UUID.randomUUID(),
                      Kilograms(8.292e18),
                      Asteroid("Cluster", 218.8.km, 217.0.km, 203.6.km),
                      Moons.Titan,
                      Titanian,
                      Seq(Skandinaviska, English),
                      Seq(Military))
      with Orbiting {
    val orbit = new LissajousOrbit(new L1(Planets.Saturn, Moons.Titan),
                                   1205.0.km,
                                   780.0.km,
                                   RotationPeriod(Days(0.3)),
                                   RotationPeriod(Days(0.14)),
  ...
  object Skathi
      extends Habitat("Skathi",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Asteroid("Cluster", 8.km, 6.km, 3.km),
                      Moons.Titan,
                      Titanian,
                      Seq(Skandinaviska, English),
                      Seq(Military))
      with Orbiting {
    val orbit = new LissajousOrbit(new L4(Planets.Saturn, Moons.Titan),
                                   32005.0.km,
                                   17008.0.km,
                                   RotationPeriod(Days(1.96)),
                                   RotationPeriod(Days(1.49)),
                                   1.84,
                                   0.0.º,
                                   0.0.º);
  }
  ...
  object Abramsen
      extends Habitat("Abramsen (S/2007 S 2)",
                      UUID.randomUUID(),
                      Kilograms(2.4e9),
                      Asteroid("Cluster", 6.km, 5.km, 3.km),
                      Moons.Titan,
                      Titanian,
                      Seq(Skandinaviska, English),
                      Seq(Military))
      with Orbiting {
    val orbit = new LissajousOrbit(new L5(Planets.Saturn, Moons.Titan),
                                   32000.0.km,
                                   17000.0.km,
                                   RotationPeriod(Days(1.91)),
                                   RotationPeriod(Days(1.41)),
                                   3.84,
                                   0.0.º,
                                   0.0.º);
  }
  ...
  object Mankell
      extends Habitat("Mankell",
                      ...
                      Titanian,
                      Seq(Skandinaviska, English),
                      Seq(ComSystems, ZeroGManufacturing))
      with Orbiting {
  ...
  object Xiphos
      extends Habitat("Xiphos",
                      UUID.randomUUID(),
                      Kilograms(3.2e10),
                      HamiltonCylinder(5.5.km, 1.0.km),
                      Planets.Uranus,
                      Ultimates,
                      Seq(English, German, Hindi),
                      Seq(Research, Security, HeavyIndustry, Sports))
      with Orbiting {
  ...
  object Glitch
      extends Habitat("Glitch",
                      UUID.randomUUID(),
                      Kilograms(3.2e8),
                      ProcessorLocus,
                      Planets.Neptune,
                      Independent(),
                      Seq(English, Japanese, Russian),
                      Seq(Research, AI, SoftwareDesign, Hacktivism))
      with Orbiting {
  ...
  object Mahogany
      extends Habitat("Mahogany",
                      UUID.randomUUID(),
                      Kilograms(1.4e10),
                      Disc(500.0.m, 50.0.m),
                      Planets.Neptune,
                      AA(Mercurials),
                      Seq(English, Indonesian, Spanish),
                      Seq.empty)
      with Orbiting {
  ...
  object Afrik
      extends Habitat("Afrik",
                      UUID.randomUUID(),
                      Kilograms(1.4e10),
                      Torus(500.0.m, 50.0.m),
                      Moons.Triton,
                      Independent(Mercurials),
                      Seq(Dutch, French),
                      Seq(Bioengineering))
      with Orbiting {
  ...
  object Free
      extends Habitat("Free (Proteus)",
                      UUID.randomUUID(),
                      Kilograms(4.4e19),
                      Asteroid("Beehive", 424.0.km, 390.0.km, 396.0.km),
                      Planets.Neptune,
                      Independent(),
                      Seq(Arabic, English, Italian),
                      Seq(Information, SignalAnalysis))
      with Orbiting {
    val orbit = VariableOrbit(0.00053,
                              Kilometers(117647),
                              Degrees(30.607975),
  ...
  object Hawking
      extends Habitat("Hawking",
                      UUID.randomUUID(),
                      Kilograms(3.22e17),
                      Asteroid("Beehive/Cluster", 112.0.km, 65.0.km, 66.0.km),
                      Stars.Sol,
                      IHypercorp,
                      Seq(Arabic, English, German),
                      Seq(RocketDesign))
      with Orbiting {
  ...
  object Ilmarinen
      extends Habitat("Ilmarinen",
                      UUID.randomUUID(),
                      Kilograms(3.23e17),
                      Asteroid("Beehive/Cluster", 132.0.km, 76.0.km, 48.0.km),
                      Stars.Sol,
                      Independent(Anarchists, Argonauts),
                      Seq(English, Farsi, Mandarin),
                      Seq(Research, MorphDesign, Hacktivism, Art, Biodesign, ImplantDesign, Robotics, SoftwareDesign))
      with Orbiting {
  ...
  object AlphaPlus
      extends Habitat("AlphaPlus",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      BernalSphere(16.0.km),
                      Stars.Sol,
                      Independent(Brinker),
                      Seq(English),
                      Seq(Mining))
      with Orbiting {
    val orbit = new LissajousOrbit(SolUranusL3,
                                   20000000.0.km,
                                   2500000.0.km,
                                   RotationPeriod(Days(50.0)),
                                   RotationPeriod(Days(10.0)),
  ...
  object NewSarpalius
      extends Habitat("New Sarpalius",
                      UUID.randomUUID(),
                      Kilograms(1.151e17), // based on https://en.wikipedia.org/wiki/7066_Nessus
                      Asteroid("Beehive", 65.0.km, 61.0.km, 57.0.km),
                      Stars.Sol,
                      Polities.PlanetaryConsortium,
                      Seq(Arabic, French),
                      Seq(Research, Mining, Transport, Trade))
      with Orbiting {
    val orbit =
      ConstantOriginOrbit(0.51987, 24.59310.AU, 15.66868.º, 31.1557.º, 170.478.º, 77.00816.º, mass, this.centre.mass);
    override def extraInfo = Seq(("Population" -> "4000"));
  }

  object ThunderOnTheHorizon
      extends Habitat("Thunder on the Horizon (10370 Hylonome)",
                      UUID.randomUUID(),
                      Kilograms(1.85e17),
                      Asteroid("Beehive and Track", 70.0.km, 67.0.km, 59.0.km),
                      Stars.Sol,
                      IndependentNamed("Bioconservative"),
                      Seq(Burmese, English, Hindi),
                      Seq.empty)
      with Orbiting {
  ...
  object Langford
      extends Habitat("Langford",
                      UUID.randomUUID(),
                      Kilograms(3.2e7),
                      Torus(120.0.m, 40.0.m),
                      Stars.Sol,
                      Argonauts,
                      Seq(English, Skandinaviska, Mandarin, Russian),
  ...
  object Haumea
      extends Habitat("Haumea",
                      UUID.randomUUID(),
                      Kilograms(4.006e21),
                      Asteroid("Beehive and Tin Can", 2322.0.km, 1704.0.km, 1138.0.km),
                      Stars.Sol,
                      CriminalNamed("Măfēng gang"),
                      Seq(Cantonese),
                      Seq(Crime, Mining, Piracy))
      with Orbiting {
  ...
  object Markov
      extends Habitat("Markov",
                      UUID.randomUUID(),
                      Kilograms(1.85e17),
                      Asteroid("Beehive", 70.0.km, 67.0.km, 59.0.km),
                      Stars.Sol,
                      Argonauts,
                      Seq(English, French, German),
                      Seq(Research, SignalAnalysis))
      with Orbiting {
    val orbit = ConstantOriginOrbit(0.1, 40.0.AU, 2.0.º, 20.0.º, 200.0.º, 200.0.º, mass, this.centre.mass);
    override def extraInfo =
      Seq(("Population" -> "3000"), ("Notes" -> "Position is a wild guess. The actual location is a secret."));
  }

  object HabitatOnTheRock
      extends Habitat("Habitat on the Rock",
                      UUID.randomUUID(),
                      Kilograms(3.2e7),
                      Cluster,
                      Stars.Sol,
  ...
  object Whiskey
      extends Habitat("Whiskey",
                      UUID.randomUUID(),
                      Kilograms(1.0e10),
                      Torus(1790.0.m, 130.0.m),
                      Stars.Sol,
                      Independent(),
                      Seq(English, Hindi, Mandarin),
                      Seq(Transport, Trade, Entertainment, Gambling, Information))
      with Orbiting {
  ...
  object Tulihaend
      extends Habitat("Tulihänd",
                      UUID.randomUUID(),
                      Kilograms(-1.30117e22), // cheated mass to fix orbit
                      Cluster,
                      Planets.Pluto,
                      Independent(Brinker),
                      Seq(Estonian, Russian),
                      Seq(Mining))
      with Orbiting {
    // FIXME It's *supposed* to be at the barycentre between Pluto and Charon
    val orbit = VariableOrbit(0.0,
                              2110.0.km,
                              112.783.º,
  ...
  object Sedna
      extends Habitat("Sedna",
                      UUID.randomUUID(),
                      Kilograms(2.0e21),
                      Asteroid("Beehive", 70.0.km, 67.0.km, 59.0.km),
                      Stars.Sol,
                      CriminalNamed("Dead Eye Society"),
                      Seq(Arabic, Hindi),
                      Seq(Mining, Piracy))
      with Orbiting {
  ...
  object Wisdom
      extends Habitat("Wisdom",
                      UUID.randomUUID(),
                      Kilograms(1.3e12),
                      Asteroid("Beehive", 40.0.km, 23.0.km, 20.0.km),
                      Stars.Sol,
                      Independent(Brinker),
                      Seq(Wu),
                      Seq(Art))
  ...
  object Evangelium
      extends Habitat("Evangelium",
                      UUID.randomUUID(),
                      Kilograms(1.3e17),
                      Asteroid("Beehive", 120.0.km, 80.0.km, 87.0.km),
                      Stars.Sol,
                      Independent(Brinker),
                      Seq(English),
                      Seq(Religion, Research))
      with Orbiting {
  ...
  val list: Seq[Habitat] = Seq(
    ...
    Zombieland,
    Amalthea,
    Settlements.Ganymede.LibertyStation.Hab,
    TheCastle,
    TheHolySee,
    JSFAntimatterFactory,
    Aoede,
    Aitne,
    Kale,
    Taygete,
    ...
    RedEmmasDance,
    SmallMajesties,
    Settlements.Titan.CommonwealthHub.Hab,
    Phoebe,
    Skathi,
    Abramsen,
    Mankell,
