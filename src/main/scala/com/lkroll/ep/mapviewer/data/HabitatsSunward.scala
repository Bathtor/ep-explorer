...
object HabitatsSunward {

  import ExtraUnits._;

  object Remembrance
      extends Habitat("Remembrance",
                      UUID.randomUUID(),
                      Kilograms(4.8e10),
                      ONeillCylinder(Kilometers(70), Kilometers(8)),
                      Planets.Earth,
                      LunarLagrangeAlliance,
                      Seq(English, Hindi, Wu),
                      Seq(Shipping, Trade, Information, Politics))
      with Orbiting {
    val orbit = new LissajousOrbit(EarthLunaL4,
                                   Kilometers(3500.0),
                                   Kilometers(2500.0),
                                   DegreesPerSecond(0.02015),
                                   DegreesPerSecond(0.0115),
                                   3.229,
                                   Degrees(0.0),
                                   Degrees(0.0));
  ...
  object Elegua
      extends Habitat("Elegua",
                      UUID.randomUUID(),
                      Kilograms(4.8e10),
                      // assume sized based on population comparison to Island Two (https://en.wikipedia.org/wiki/Bernal_sphere)
                      ModifiedBernalSphere(Kilometers(1.8)),
                      Planets.Earth,
                      TerraGenesis,
                      Seq(Dutch, English, Vietnamese),
                      Seq(Terraforming, EcosystemManagement, EnvironmentalData))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0,
                                  Kilometers(112000),
                                  Degrees(12.5),
                                  Degrees(0.0),
                                  Degrees(0.0),
  ...
  object FreshKills
      extends Habitat("Fresh Kills",
                      UUID.randomUUID(),
                      Kilograms(4.8e7),
                      Cluster,
                      Planets.Earth,
                      Independent(Scum),
                      Seq(English, French, Tamil),
                      Seq(Salvage))
      with Orbiting {
    val orbit = new LissajousOrbit(EarthLunaL5,
                                   Kilometers(19000.0),
                                   Kilometers(12000.0),
                                   DegreesPerSecond(0.0310),
                                   DegreesPerSecond(0.0310),
                                   2.10780125,
                                   Degrees(90.0),
                                   Degrees(45.0));
  ...
  object Hexagon
      extends Habitat("Hexagon",
                      UUID.randomUUID(),
                      Kilograms(4.8e10),
                      ModifiedTorus(Kilometers(1.79), Kilometers(0.13)),
                      Planets.Earth,
                      PlanetaryConsortium(DirectAction),
                      Seq(English, German, Mandarin),
                      Seq(MilitaryTech, Research, Training))
      with Orbiting {
    val orbit = new LissajousOrbit(EarthLunaL5,
                                   Kilometers(19000.0),
                                   Kilometers(12000.0),
  ...
  object HotelCalifornia
      extends Habitat("Hotel California",
                      UUID.randomUUID(),
                      Kilograms(4.8e10),
                      Asteroid("Beehive/Dome", Kilometers(3.0), Kilometers(1.2), Kilometers(1.5)),
                      Planets.Earth,
                      Independent(Brinker),
                      Seq(Bengali, Hindi),
                      Seq())
    ...
    val orbit = new LissajousOrbit(EarthLunaL4,
                                   Kilometers(7000.0),
                                   Kilometers(4200.0),
                                   DegreesPerSecond(0.017),
                                   DegreesPerSecond(0.034),
                                   3.82387286764706,
                                   Degrees(35.0),
                                   Degrees(125.0));
    //override def extraInfo = Seq(("Population" -> "120 000"));
  ...
  object Paradise
      extends Habitat("Paradise",
                      ...
                      Seq(English, Italian),
                      Seq(ResortServices, Tourism))
      with Orbiting {
    val orbit = new LissajousOrbit(SunEarthL1,
                                   Kilometers(4300.0),
                                   Kilometers(1200.0),
                                   DegreesPerSecond(0.017),
                                   DegreesPerSecond(0.017),
  ...
  object VoNguyen
      extends Habitat("Vo Nguyen",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      ONeillCylinder(Kilometers(64), Kilometers(4)),
                      Planets.Earth,
                      LunarLagrangeAlliance,
                      Seq(French, Vietnamese),
                      Seq(Research, Salvage))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0,
                                  Kilometers(42164),
                                  Degrees(23.44),
  ...
  object SeleneStation
      extends Habitat(
        "Selene Station",
        UUID.randomUUID(),
        Kilograms(2.4e10), // I tried to calculate that from the speed and orbit given in the book, but I always come up with negative mass solutions^^
        Torus(Kilometers(6.0), Kilometers(0.7)),
        Moons.Luna,
        Polities.PlanetaryConsortium,
        Seq(English),
        Seq(Transport, ZeroGManufacturing)
      )
      with Orbiting {
    val orbit = new ConstantOrbit(0.0,
                                  Kilometers(11737.1),
  ...
  object KorolevShipyards
      extends Habitat("Korolev Shipyards",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Cluster,
                      Moons.Luna,
  ...
  object MVCPR
      extends Habitat("Mare Vaporium Circumlunar People's Republic",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      ONeillCylinder(Kilometers(64), Kilometers(4)),
                      Moons.Luna,
                      ...
                      Seq(Counterfeiting, Salvage, Scavenging))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0,
                                  Kilometers(27737.1),
                                  Degrees(23.5),
  ...
  object Mitre
      extends Habitat("Mitre",
                      UUID.randomUUID(),
                      Kilograms(1.1e9),
                      Cluster,
                      Moons.Luna,
                      Independent(Argonauts),
                      Seq(English, Mandarin),
                      Seq(Research, Information))
      with Orbiting {
    val orbit = new ConstantOrbit(0.005,
                                  Kilometers(75737.1),
                                  Degrees(87.8),
                                  Degrees(30.0),
                                  Degrees(80.0),
  ...
  object Tsukomo
      extends Habitat("Tsukomo",
                      UUID.randomUUID(),
                      Kilograms(1.0e10),
                      Torus(Kilometers(0.9), Kilometers(0.065)),
                      Moons.Luna,
                      LunarLagrangeAlliance,
                      Seq(Japanese),
                      Seq())
  ...
  // Mars
  object Progress
      extends Habitat("Progress (Deimos)",
                      UUID.randomUUID(),
                      Kilograms(1.4762e15),
                      Asteroid("Cole bubble (cylindrical)", 15.0.km, 12.2.km, 11.0.km),
                      Planets.Mars,
                      Polities.PlanetaryConsortium,
                      Seq(Mandarin, Hindi, English, Russian, Spanish, Arabic, French),
  ...
  object Pontes
      extends Habitat("Pontes",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      ONeillCylinder(Kilometers(64), Kilometers(4)),
                      Planets.Mars,
                      Polities.PlanetaryConsortium,
                      Seq(Portuguese, Spanish, English, Mandarin),
                      Seq(ZeroGManufacturing, AerospaceEngineering, RocketDesign))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0,
                                  Kilometers(25737.1),
                                  Degrees(27.5),
  ...
  object McClintock
      extends Habitat("McClintock",
                      ...
                      Kilograms(4.8e10),
                      ModifiedTorus(Kilometers(1.79), Kilometers(0.13)),
                      Planets.Mars, // doesn't actually say which type...
                      PlanetaryConsortium(Ecologene),
                      Seq(English),
  ...
  object LuXing
      extends Habitat("Lu Xing",
                      ...
                      Seq(Research, GeneticalEngineering, FoodIndustry))
      with Orbiting {
  ...
  object Ptah
      extends Habitat("Ptah",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Torus(Kilometers(0.845), Kilometers(0.065)),
                      Planets.Mars, // doesn't actually say which type...
                      PlanetaryConsortium(Skinaesthesia),
                      Seq(English),
  ...
  object Batteries123
      extends Habitat("Batteries 1/2/3",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Cluster,
                      Planets.Mars,
                      ...
                      Seq())
      with Orbiting {
    val orbit = new LissajousOrbit(MarsPhobosL4,
                                   Kilometers(700.0),
                                   Kilometers(420.0),
                                   DegreesPerSecond(0.017),
                                   DegreesPerSecond(0.0034),
                                   3.82387286764706,
                                   Degrees(35.0),
                                   Degrees(125.0));
    //override def extraInfo = Seq(("Population" -> "25 000"), ("Owner" -> "Starware"));
  ...
  object Batteries456
      extends Habitat("Batteries 4/5/6",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Cluster,
                      Planets.Mars,
                      ...
                      Seq())
      with Orbiting {
    val orbit = new LissajousOrbit(MarsPhobosL5,
                                   Kilometers(700.0),
                                   Kilometers(420.0),
                                   DegreesPerSecond(0.017),
                                   DegreesPerSecond(0.0034),
  ...
  // Venus
  object Gerlach
      extends Habitat("Gerlach",
                      UUID.randomUUID(),
                      Kilograms(1.2e9),
                      ONeillCylinder(Kilometers(4), Kilometers(0.5)),
                      Planets.Venus,
                      Independent(NoPolity),
                      Seq(Cantonese, English, Polish),
                      Seq(Trade, Shipping, Research, Terraforming, Biodesign))
      with Orbiting {
    val orbit = new ConstantOrbit(0.0, 47000.0.km, 27.5.º, 0.0.º, 0.0.º, 180.0.º, this.mass, this.centre);
    override def extraInfo = Seq(("Population" -> "120 000"));
  }
  object Thought
      extends Habitat("Thought",
                      UUID.randomUUID(),
                      Kilograms(1.2e10),
                      Torus(Kilometers(0.845), Kilometers(0.065)),
                      Planets.Venus,
                      PlanetaryConsortium(Cognite),
                      Seq(English, German),
  ...
  object FarReachII
      extends Habitat("Far Reach II",
                      ...
                      Seq(Chemistry, Research, Nanofabrication))
      with Orbiting {
  ...
  object Cythera
      extends Habitat("Cythera",
                      ...
                      Seq(Bengali, Punjabi),
                      Seq(Research, Terraforming, EcosystemManagement, Biodesign))
      with Orbiting {
  ...
  object Frostfire
      extends Habitat("Frostfire",
                      UUID.randomUUID(),
                      Kilograms(4.2e9),
                      Cluster,
                      Planets.Venus,
                      MorningstarConstellation,
                      Seq(Portuguese, Spanish),
                      Seq(Shipping, WaterExtraction))
      with Orbiting {
  ...
  object Aten
      ...
      with Orbiting {
    val orbit =
      new ConstantOriginOrbit(0.515152, 1.65e6.km, 63.87.º, 286.13.º, 116.13.º, 0.0.º, this.mass, Stars.Sol.mass);
    override def extraInfo = Seq(("Population" -> "12 000"));
  }
  object HoovermanGeischeker
      extends Habitat("Hooverman-Geischecker",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Cluster,
                      Stars.Sol,
                      Seq(Argonauts, Titanian),
                      Seq(),
                      Seq(Research))
      with Orbiting {
    val orbit =
      new ConstantOriginOrbit(0.52456, 1.85e6.km, 63.87.º, 280.13.º, 116.13.º, 0.0.º, this.mass, Stars.Sol.mass);
    override def extraInfo =
      Seq(("Population" -> "4 000"), ("Sponsors" -> "Argonauts and Titan Autonomous University"));
  }
  object UkkoJylinä
      extends Habitat("Ukko Jylinä",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Cluster,
                      Stars.Sol,
      ...
      with Orbiting {
    val orbit =
      new ConstantOriginOrbit(0.50456, 1.75e6.km, 63.87.º, 283.13.º, 116.13.º, 0.0.º, this.mass, Stars.Sol.mass);
    override def extraInfo = Seq(("Population" -> "300 - 3 000"));
  }

  object V2011Caldwell
      extends Habitat("V/2011 Caldwell (Vulcanoid Gate)",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Asteroid("Dome", 3.0.km, 1.4.km, 2.3.km),
                      Stars.Sol,
                      TerraGenesis,
                      Seq(Dutch, English, Tamil),
                      Seq(Gatecrashing, Terraforming))
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.243,
                                        0.19.AU,
                                        7.00487.º,
                                        48.33167.º,
                                        29.12478.º,
  ...
  object Quartet1
      extends Habitat("Quartet I",
                      UUID.randomUUID(),
                      Kilograms(1.2e10),
                      Torus(Kilometers(0.845), Kilometers(0.065)),
                      Stars.Sol,
                      Hypercorp(TerraGenesis),
                      Seq(English, Dutch, Tamil, Wu),
                      Seq(Research, Terraforming, Military))
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.243,
                                        0.19033422936.AU,
                                        7.00487.º,
  ...
  object V2014Ra
      extends Habitat("V/2014 Ra",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Asteroid("Cole Bubble", 2.3.km, 1.7.km, 1.4.km),
                      Stars.Sol,
                      Solarian,
                      Seq(English, French),
                      Seq())
      with Orbiting {
    val orbit = new ConstantOriginOrbit(0.201,
                                        0.12.AU,
                                        12.00487.º,
                                        46.73463.º,
                                        29.12478.º,
  ...
  object TheEgg
    ...
    override def extraInfo =
      Seq(("Note" -> "The purpose and function of The Egg is unkown, but it is off limits to transhumanity."));
  }
  object Hellwatch
      extends Habitat("Hellwatch",
                      UUID.randomUUID(),
                      Kilograms(1.2e9),
                      Torus(Kilometers(0.4225), Kilometers(0.0325)),
                      Planets.Mercury,
                      Polities.PlanetaryConsortium,
                      Seq(Arabic, English, Urdu),
                      Seq(Management))
      with Orbiting {
  ...
  // Inner Fringe
  object Atira
      extends Habitat("Atira",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Cluster,
                      Stars.Sol,
                      Independent(Criminal, LosZetas),
                      Seq(Spanish),
                      Seq(Drugs, Chemistry))
      with Orbiting {
    val orbit =
  ...
  object Eros
      extends Habitat("Eros",
                      UUID.randomUUID(),
                      Kilograms(4.2e12),
                      Asteroid("Beehive", 34.0.km, 11.2.km, 11.1.km),
                      Stars.Sol,
                      PlanetaryConsortium(RedZone),
                      Seq(English, Russian, Spanish, Urdu),
                      Seq(Mining, Military))
      with Orbiting {
    val orbit =
  ...
  object Geographos
      extends Habitat("Geographos/SYNAPSCAPE",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Asteroid("Beehive", 5.0.km, 1.8.km, 1.8.km),
                      Stars.Sol,
                      PlanetaryConsortium(Cognite),
                      Seq(English, Vietnamese),
                      Seq(Research, AI))
      with Orbiting {
  ...
  object Impian
      extends Habitat("Impian",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Asteroid("Cole Bubble", 5.0.km, 1.8.km, 1.8.km),
                      Stars.Sol,
                      Independent(Triad),
                      Seq(Indonesian, Cantonese, Malay, Tamil),
                      Seq(SoftwareDesign))
      with Orbiting {
  ...
  object LonelyMountain
      extends Habitat("Lonely Mountain",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Asteroid("Beehive", 2.5.km, 1.1.km, 1.2.km),
                      Stars.Sol,
                      Independent(Private, Hyperelite),
                      Seq(Spanish),
                      Seq())
      with Orbiting {
  ...
  object Phaethon
      extends Habitat("Phaethon",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Asteroid("Beehive", 5.1.km, 5.0.km, 5.1.km),
                      Stars.Sol,
                      Independent(Brinker, TechnoCreationists),
                      Seq(Wu),
                      Seq())
      with Orbiting {
  ...
  object Sisyphus
      extends Habitat("Sisyphus",
                      UUID.randomUUID(),
                      Kilograms(4.2e11),
                      Asteroid("Cluster", 5.1.km, 5.0.km, 5.1.km),
                      Stars.Sol,
                      Independent(Zrbny.asPolity()),
                      Seq(),
  ...
  object TheSummit
      extends Habitat("The Summit",
                      ...
                      Asteroid("Beehive", 5.1.km, 5.0.km, 5.1.km),
                      Stars.Sol,
                      Independent(Hyperelite),
                      Seq(English, Hindi, Japanese, Mandarin),
                      Seq())
      with Orbiting {
    val orbit =
  ...
  // Martian Trojans
  object Introspect
      extends Habitat("Introspect",
                      UUID.randomUUID(),
                      Kilograms(2.4e10),
                      Torus(Kilometers(0.845), Kilometers(0.065)),
                      Stars.Sol,
                      PlanetaryConsortium(ExoTech),
                      Seq(English),
                      Seq(Research, AI, ImplantDesign))
      with Orbiting {
    val orbit = new LissajousOrbit(SolMarsL5,
                                   2500000.0.km,
                                   25000.0.km,
                                   RotationPeriod(Days(6.0)),
                                   RotationPeriod(Days(1.0)),
                                   3.229,
                                   Degrees(78.0),
                                   Degrees(56.0));
    //override def extraInfo = Seq(("Owner" -> "Nazareno Batista"));
  ...
  object MemoryHole
      extends Habitat("Memory Hole",
                      ...
                      Torus(Kilometers(0.845), Kilometers(0.065)),
                      Stars.Sol,
                      PlanetaryConsortium(StellarIntelligence),
                      Seq(English, Mandarin),
                      Seq(SignalAnalysis, Research))
      with Orbiting {
    val orbit = new LissajousOrbit(SolMarsL4,
                                   200000.0.km,
                                   76538.0.km,
                                   RotationPeriod(Days(5.0)),
                                   RotationPeriod(Days(3.0)),
                                   2.229,
                                   Degrees(23.0),
                                   Degrees(87.0));
    //override def extraInfo = Seq(("Owner" -> "Nazareno Batista"));
  ...
  object QingLong
      extends Habitat("Qing Long",
                      UUID.randomUUID(),
                      Kilograms(2.4e11),
                      ONeillCylinder(Kilometers(140), Kilometers(8)),
                      Stars.Sol,
                      Seq(Polities.PlanetaryConsortium, Triad),
                      Seq(Cantonese, Korean, Mandarin, Vietnamese),
                      Seq(Trade, AerospaceEngineering, Crime, Gambling, Entertainment))
      with Orbiting {
    val orbit = new LissajousOrbit(SolMarsL5,
                                   5000000.0.km,
                                   200000.0.km,
                                   RotationPeriod(Days(12.0)),
                                   RotationPeriod(Days(12.0)),
                                   3.829,
                                   Degrees(40.0),
                                   Degrees(120.0));
  ...
  object Transix
      extends Habitat("Transix",
                      UUID.randomUUID(),
                      Kilograms(8.4e11),
                      Cluster,
                      Stars.Sol,
                      PlanetaryConsortium(ComEx),
                      Seq(English, Russian),
                      Seq(Shipping, Entertainment))
      with Orbiting {
    val orbit = new LissajousOrbit(SolMarsL4,
                                   5000000.0.km,
                                   2000000.0.km,
                                   RotationPeriod(Days(12.0)),
                                   RotationPeriod(Days(8.0)),
                                   2.929,
                                   Degrees(120.0),
                                   Degrees(10.0));
    //override def extraInfo = Seq(("Population" -> "2 million+"));
  ...
  object ElysianFields
      extends Habitat("Elysian Fields",
                      UUID.randomUUID(),
                      Kilograms(1.2e11),
                      ONeillCylinder(Kilometers(64), Kilometers(8)),
                      Stars.Sol,
                      Independent(Brinker),
                      Seq(English, Japanese),
                      Seq())
      with Orbiting {
    val orbit = new LissajousOrbit(SolEarthL3,
                                   1250000.0.km,
                                   100000.0.km,
                                   RotationPeriod(Days(6.0)),
                                   RotationPeriod(Days(0.5)),
                                   4.229,
                                   Degrees(0.0),
                                   Degrees(0.0));
    //override def extraInfo = Seq(("Population" -> "2 million+"));
  ...
  object PEX
      extends Habitat("PEX",
                      ...
                      Seq(Finance, Trade))
      with Orbiting {
    val orbit = new LissajousOrbit(SolMarsL2,
                                   60000.0.km,
                                   30000.0.km,
                                   RotationPeriod(Days(5.0)),
                                   RotationPeriod(Days(2.5)),
                                   2.229,
                                   Degrees(0.0),
                                   Degrees(0.0));
