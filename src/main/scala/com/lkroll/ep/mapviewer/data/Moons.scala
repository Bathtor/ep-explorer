...
object Moons {
  ...
  // Earth
  object Luna
      extends Moon("Luna", UUID.randomUUID(), Kilograms(7.342e22), Kilometers(1737.1), Planets.Earth, 1)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(
      0.0549,
      Kilometers(384399),
      Degrees(5.145),
  ...
  // Mars
  object Phobos
      extends Moon("Phobos", UUID.randomUUID(), Kilograms(1.0659e16), Kilometers(11.2667), Planets.Mars, 1)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0151,
                              Kilometers(9376),
                              Degrees(26.04),
    ...
    override def extraInfo =
      Seq(
        ("Allegiance" -> Polities.PlanetaryConsortium.adjective),
        ("Owner" -> "Cognite"),
        ("Offices" -> Seq(DirectAction.name, ComEx.name, EngDilworth.name).mkString(", ")),
  ...
  // Jupiter
  object Io
      extends Moon("Io", UUID.randomUUID(), Kilograms(8.931938e22), Kilometers(1821.6), Planets.Jupiter, 1)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0041,
                              Kilometers(421700),
                              Degrees(2.213),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Europa
      extends Moon("Europa", UUID.randomUUID(), Kilograms(4.799844e22), Kilometers(1560.8), Planets.Jupiter, 2)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.009,
                              Kilometers(670900),
                              Degrees(1.791),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Ganymede
      extends Moon("Ganymede", UUID.randomUUID(), Kilograms(1.4819e23), Kilometers(2634.1), Planets.Jupiter, 3)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0013,
                              Kilometers(1070400),
                              Degrees(2.214),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Callisto
      extends Moon("Callisto", UUID.randomUUID(), Kilograms(1.075938e23), Kilometers(2410.3), Planets.Jupiter, 4)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0074,
                              Kilometers(1882700),
                              Degrees(2.017),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  // Saturn
  object Titan
      extends Moon("Titan", UUID.randomUUID(), Kilograms(1.3452e23), Kilometers(2575.5), Planets.Saturn, 6)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0288,
                              Kilometers(1221870),
                              Degrees(29.56378),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Pandora
      extends Moon("Pandora", UUID.randomUUID(), Kilograms(1.371e17), Kilometers(40.7), Planets.Saturn, 17)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0042,
                              Kilometers(141720),
                              Degrees(29.26524),
                              ConstantAngle(Degrees(113.665)),
                              ConstantAngle(Degrees(339.392)),
                              Degrees(317.020),
                              mass,
                              Planets.Saturn);
    val rotation = ECR(22.5769768.ºd, 39.4827.º, 83.4279.º, 186.5855.º);
  ...
  object Iapetus
      extends Moon("Iapetus", UUID.randomUUID(), Kilograms(1.805635e21), Kilometers(734.5), Planets.Saturn, 8)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0286125,
                              Kilometers(3560820),
                              Degrees(17.28),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Rhea
      extends Moon("Rhea", UUID.randomUUID(), Kilograms(2.306518e21), Kilometers(763.8), Planets.Saturn, 5)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0012583,
                              Kilometers(527108),
                              Degrees(29.56024),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Tethys
      extends Moon("Tethys", UUID.randomUUID(), Kilograms(6.17449e20), Kilometers(531.1), Planets.Saturn, 3)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0001,
                              Kilometers(294619),
                              Degrees(30.33524),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Enceladus
      extends Moon("Enceladus", UUID.randomUUID(), Kilograms(1.08022e20), Kilometers(252.1), Planets.Saturn, 2)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0047,
                              Kilometers(237948),
                              Degrees(29.23424),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Dione
      extends Moon("Dione", UUID.randomUUID(), Kilograms(1.095452e21), Kilometers(561.4), Planets.Saturn, 4)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0022,
                              Kilometers(377396),
                              Degrees(29.23424),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Mimas
      extends Moon("Mimas", UUID.randomUUID(), Kilograms(3.7493e19), Kilometers(198.2), Planets.Saturn, 1)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0196,
                              Kilometers(185539),
                              Degrees(30.78924),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  // Uranus
  object Miranda
      extends Moon("Miranda", UUID.randomUUID(), Kilograms(6.59e19), Kilometers(235.8), Planets.Uranus, 5)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0013,
                              Kilometers(129390),
  ...
  object Ariel
      extends Moon("Ariel", UUID.randomUUID(), Kilograms(1.353e21), Kilometers(578.9), Planets.Uranus, 1)
      with Orbiting
      with Rotating {
    import Languages._;
    import Polities._;

    val orbit = VariableOrbit(0.0012,
                              Kilometers(191020),
                              Degrees(98.03),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
    ...
    override def extraInfo =
      Seq(Allegiance(Ultimates), PrimaryLanguages(English, Hindi, Mandarin), ("Population" -> "2000"))
  }
  object Umbriel
      extends Moon("Umbriel", UUID.randomUUID(), Kilograms(1.172e21), Kilometers(584.7), Planets.Uranus, 2)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0039,
                              Kilometers(266000),
                              Degrees(97.898),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Titania
      extends Moon("Titania", UUID.randomUUID(), Kilograms(3.527e21), Kilometers(788.4), Planets.Uranus, 3)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0011,
                              Kilometers(435910),
                              Degrees(98.11),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Oberon
      extends Moon("Oberon", UUID.randomUUID(), Kilograms(3.014e21), Kilometers(761.4), Planets.Uranus, 4)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0014,
                              Kilometers(583520),
                              Degrees(97.828),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  // Neptune
  object Nereid
      extends Moon("Nereid", UUID.randomUUID(), Kilograms(3.09e19), Kilometers(170), Planets.Neptune, 2)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.7507,
                              Kilometers(5513787),
                              Degrees(62.637975),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Triton
      extends Moon("Triton", UUID.randomUUID(), Kilograms(2.14e22), Kilometers(1353.4), Planets.Neptune, 1)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.000016,
                              Kilometers(354759),
                              Degrees(129.812),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Naiad
      extends Moon("Naiad", UUID.randomUUID(), Kilograms(1.9e17), Kilometers(33), Planets.Neptune, 3)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0004,
                              Kilometers(48227),
                              Degrees(34.837975),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Thalassa
      extends Moon("Talassa", UUID.randomUUID(), Kilograms(3.5e17), Kilometers(41), Planets.Neptune, 4)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0002,
                              Kilometers(50075),
                              Degrees(30.297975),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Despina
      extends Moon("Despina", UUID.randomUUID(), Kilograms(2.2e18), Kilometers(75), Planets.Neptune, 5)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0002,
                              Kilometers(52526),
  ...
  object Galatea
      extends Moon("Galatea", UUID.randomUUID(), Kilograms(2.12e18), Kilometers(88), Planets.Neptune, 6)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.00004,
                              Kilometers(61953),
                              Degrees(30.139975),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Larissa
      extends Moon("Larissa", UUID.randomUUID(), Kilograms(4.2e18), Kilometers(97), Planets.Neptune, 7)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.001393,
                              Kilometers(73548),
                              Degrees(30.338975),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  // Pluto
  object Charon
      extends Moon("Charon", UUID.randomUUID(), Kilograms(1.586e21), Kilometers(606), Planets.Pluto, 1)
      with Orbiting
      with Rotating {
  ...
  object Styx
      extends Moon("Styx", UUID.randomUUID(), Kilograms(7.5e15), Kilometers(9), Planets.Pluto, 2)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.005787,
                              Kilometers(42656),
                              Degrees(140.499),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Nix
      extends Moon("Nix", UUID.randomUUID(), Kilograms(4.5e16), Kilometers(35), Planets.Pluto, 3)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.0,
                              Kilometers(48694),
  ...
  object Kerberos
      extends Moon("Kerberos", UUID.randomUUID(), Kilograms(1.65e16), Kilometers(10), Planets.Pluto, 4)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.00328,
                              Kilometers(57783),
                              Degrees(140.079),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  object Hydra
      extends Moon("Hydra", UUID.randomUUID(), Kilograms(4.8e16), Kilometers(45), Planets.Pluto, 5)
      with Orbiting
      with Rotating {
    val orbit = VariableOrbit(0.005862,
                              Kilometers(64738),
                              Degrees(139.932),
                              ConstantAngle(Degrees(0.0)),
                              ConstantAngle(Degrees(0.0)),
  ...
  // Eris
  object Dysnomia
      extends Moon("Dysnomia", UUID.randomUUID(), Kilograms(2.0e20), Kilometers(342), Planets.Eris, 1)
      with Orbiting
      with Rotating {
  ...
  val colours = Map(
    ...
    Callisto.name -> 0x848381,
    Titan.name -> 0xcfc063,
    Iapetus.name -> 0x848381,
    Rhea.name -> 0x848381,
    Tethys.name -> 0x848381,
    Enceladus.name -> 0x848381,
    Dione.name -> 0x848381,
    Mimas.name -> 0x848381,
    Miranda.name -> 0x848381,
    Ariel.name -> 0x848381,
    Umbriel.name -> 0x646361,
    Titania.name -> 0x848381,
    Oberon.name -> 0x848381,
    Nereid.name -> 0x848381,
    Triton.name -> 0x848381,
    Naiad.name -> 0x848381,
    Thalassa.name -> 0x848381,
    Despina.name -> 0x848381,
    Galatea.name -> 0x848381,
    Charon.name -> 0x848381,
    Styx.name -> 0x848381,
    Nix.name -> 0x848381,
    Kerberos.name -> 0x848381,
    Hydra.name -> 0x848381,
