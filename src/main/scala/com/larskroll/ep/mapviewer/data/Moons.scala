...
object Moons {
  ...
  object Pandora extends Moon("Pandora", UUID.randomUUID(),
    Kilograms(1.371e17), Kilometers(40.7), Planets.Saturn, 17) with Orbiting with Rotating {
    val orbit = VariableOrbit(0.0042, Kilometers(141720), Degrees(29.26524),
      ConstantAngle(Degrees(113.665)),
      ConstantAngle(Degrees(339.392)),
      Degrees(317.020), mass, Planets.Saturn);
    val rotation = ECR(22.5769768.ºd, 39.4827.º, 83.4279.º, 186.5855.º);
  }
