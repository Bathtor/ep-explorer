...
import com.larskroll.ep.mapviewer.data.{ Settlement => SettlementData, Aerostat => AerostatData, SyncOrbitStation => SyncOrbitStationData, PandoraGate => PandoraGateData, AstronomicalObject, AtmosphericObject => AtmosphericObjectData }
